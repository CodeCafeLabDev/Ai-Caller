...
export function AddClientForm({ onSuccess, onCancel, client }: AddClientFormProps) {
  ...
  const form = useForm<AddClientFormValues>({
    ...
    defaultValues: client ? {
      ...
      apiAccess: Boolean(client.apiAccess),
      trialMode: Boolean(client.trialMode),
      trialDuration: client.trialDuration || 0,
      trialCallLimit: client.trialCallLimit || 0,
      adminPassword: "",
      confirmAdminPassword: "",
      autoSendLoginEmail: client.autoSendLoginEmail !== undefined ? Boolean(client.autoSendLoginEmail) : true,
    } : {
      companyName: "",
      companyEmail: "",
      phoneNumber: "",
